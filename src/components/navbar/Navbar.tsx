  ...
  return (
    ...
    >
      <div className="flex items-center lg:gap-8 2xl:gap-12">
        ...
        <div className="flex items-center lg:gap-[10px] 2xl:gap-[14px]">
          {navs?.map((nc) => (
            <div
              key={nc?.title}
            ...
            >
              <div className="lg:h-[15px] lg:w-[15px] 2xl:h-[20px] 2xl:w-[20px]">
                <img
                  className="h-full w-full"
                  src={`${
                    activeTab === nc?.title ? nc?.activeIcon : nc?.passiveIcon
                  }`}
                  alt={nc?.title}
                />
              </div>
